...
>
  <p data-testid="test">
    You can override
    <strong>the following identifers name</strong> that belongs to this Storybook
    addon:
  </p>
  ...
  <ul>
    ...
    <li>
      <code>
        destructured `Story` from `defineMeta` (or whatever you renamed it to)
        call
      </code>
    </li>
    ...
    <li>
      <code>
        destructured `meta` from `defineMeta` (or whatever you renamed it to)
        call
      </code>
    </li>
  </ul>
