...
export async function extractMetaPropertiesNodes<
	const Properties extends Array<keyof Meta>,
>(options: Options<Properties>): Promise<Result<Properties>> {
...
function getFirstArgumentObjectExpression(
