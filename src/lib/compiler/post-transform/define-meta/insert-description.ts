...
import { createASTObjectExpression, createASTProperty, type ESTreeAST } from '$lib/parser/ast';
...
import { getDefineMetaFirstArgumentObjectExpression } from '$lib/parser/extract/svelte/define-meta';
